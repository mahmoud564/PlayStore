...
import { CategoriesFunction } from '../../Resux/ShowDataSlice'
...
export default function Categories() {
  ...
  async function ShowData(params){
    Dispatch(isLoding())
let respons=await Dispatch(CategoriesFunction(params))
...
Dispatch(notLoding())
 ...
 // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  <><div className=' container mt-5 pt-5 text-center'>
    <div className="row">
      {
        data?.map((elmant)=><div key={elmant.id}className=" col-lg-3 col-md-4  col-sm-6 p-3 card-home cursor-pointer">
